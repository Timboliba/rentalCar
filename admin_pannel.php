...
<body>
    <?php
        if(isset($_SESSION["open"]) && $_SESSION["role"]=="admin"){
            echo'<div class="container-fluid" style="height: inherit;">';
        echo'<div class="row" style="height:inherit;">';
            echo'<div class="col-md-4" >';
            echo'<div class="navbar-collapse">';
                    echo'<div class="col-md-2">';
                    echo'<span style="color:yellow;">';
                            echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-data-fill" viewBox="0 0 16 16">
                                <path d="M10 .5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5.5.5 0 0 1-.5.5.5.5 0 0 0-.5.5V2a.5.5 0 0 0 .5.5h5A.5.5 0 0 0 11 2v-.5a.5.5 0 0 0-.5-.5.5.5 0 0 1-.5-.5Z"/>
                                <path d="M4.085 1H3.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1h-.585c.055.156.085.325.085.5V2a1.5 1.5 0 0 1-1.5 1.5h-5A1.5 1.5 0 0 1 4 2v-.5c0-.175.03-.344.085-.5ZM10 7a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7Zm-6 4a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1Zm4-3a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0V9a1 1 0 0 1 1-1Z"/>
                            </svg>';
                        echo'</span>';
                    echo'<a data-role="tableau_de_board">Tableau de bord</a></div>';
                    ...
                    echo'<div class="col-md-2">';
                        ...
                        echo'<a data-role="vehicule">Gérer les Véhicules</a></div>';
                    echo'<div class="col-md-2">';
                    ...
                    echo'<a data-role="temoignage">Gérer les Témoignages</a></div>';
                    echo'<div class="col-md-2">';
                    ...
                    echo'<a data-role="requete">Gérer les Reservations</a></div>';
                    ...
                    echo'<div class="col-md-2">';
                        ...
                        echo'<a data-role="utilisateur">Utilisateur enregistrés</a></div>';
                    echo'<div class="col-md-2">';
                    ...
                    echo'<a href="index1.php" style="text-decoration:none; color:white;">Visualiser le site</a></div>';
                    echo'<div class="col-md-2">';
                    ...
                    echo'<a href="#"  data-role="addcar" style="text-decoration:none; color:white;">Ajout de voiture</a></div>';
                    echo'<div class="col-md-2" >';
                        echo'<span style="color:red;">
                        ...
                        echo'<a href="log_out.php" style="color:white;">DECONNEXION</a></div>';
                echo'</div>
            </div>';
            echo'<div class="col-md-8"  style="background-color:silver;color:black;overflow-y:auto;">';
